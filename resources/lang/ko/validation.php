...
return [
    ...
    */
    ...
    'confirmed'      => ':attribute가 서로 동일하지 않습니다.',
    ...
    'email'          => '올바른 :attribute 형식으로 입력해주세요. ',
    ...
    'max' => [
        'numeric' => ':attribute는 문자 숫자 조합 :max자 이상으로 입력해주세요.',
    ...
    'min'       => [
        'numeric' => ':attribute는 문자 숫자 조합 :min자 이상으로 입력해주세요.',
    ...
    'not_regex'            => '12:attribute의 형식이 올바르지 않습니다.',
    'numeric'              => ':attribute은(는) 숫자여야 합니다.',
    'password'             => ':attribute은 잘못되었습니다.',
    'present'              => ':attribute 필드가 있어야 합니다.',
    'regex'                => ':attribute 형식이 유효하지 않습니다.',
    'required'             => ':attribute 선택해주세요.',
    ...
    */
    ...
    'custom' => [
        'password' => [
            'regex' => '비밀번호는 문자 숫자 조합 8자 이상으로 입력해주세요.',
        ],
        'current_password' => [
            'regex' => '비밀번호는 문자 숫자 조합 8자 이상으로 입력해주세요.',
        ],
        ...
        'phone' => [
            'min' => '휴대폰 번호를 다시 입력해주세요.',
            'max' => '휴대폰 번호를 다시 입력해주세요.',
            'unique' => '이미 사용중인 전화번호입니다.'
        ],
        'email' => [
            'email' => '올바른 이메일주소를 입력해주세요.'
        ],
        'license_number' => [
            'required' => "면허 정보를 다시 입력해주세요."
        ],
        'type_of_license_id' => [
            'required' => "면허정보를 다시 입력해 주세요."
        ],
        'area_license' => [
            'required' => "면허 정보를 다시 입력해주세요."
        ],
        'issued_date' => [
            'after_or_equal' => "발급일이 만료일보다 빠를수 없습니다."
        ],
        'date_time_extension' => [
            '*' => "date_time_extension invalid"
        ],
        'password' => [
            'min' => '비밀번호는 문자 숫자 조합 8자 이상으로 입력해주세요.'
        ]
    ],
